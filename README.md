...
I used Devise to handle user authentication. Only registered and signed-in users can see any of the active options. Please take a look at application.example.yml for guidance on setting up your application.yml file.
